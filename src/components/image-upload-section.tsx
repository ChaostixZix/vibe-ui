      ...
      {images.length > 0 && (
        <div className="grid grid-cols-2 gap-2">
          {images.map((image) => (
            <div
              key={image.id}
              className="relative group border rounded-none p-2 bg-background"
            >
              <div className="flex items-center gap-2">
                {image.url ? (
                  ...
                  <div className="h-16 w-16 bg-muted rounded-none flex items-center justify-center">
      ...
      {uploadingFiles.size > 0 && (
        <div className="space-y-1">
          {Array.from(uploadingFiles).map((tempId) => (
            ...
            >
              <div className="h-3 w-3 border-2 border-primary border-t-transparent rounded-none animate-spin" />
              <span>Uploading...</span>
            </div>
          ))}
        </div>
